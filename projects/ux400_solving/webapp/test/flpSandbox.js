		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX400  문제",
									"targetURL": "#sapbtpux400solving-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux400solving-display": {
								"semanticObject": "sapbtpux400solving",
								"action": "display",
								"description": "UX400 문제",
								"title": "UX400  문제",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux400solving",
									"url": sap.ui.require.toUrl("sap/btp/ux400solving")
								}
							}
						}
					}
