		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX400문제",
									"targetURL": "#sapbtpprojectm01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpprojectm01-display": {
								"semanticObject": "sapbtpprojectm01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.projectm01",
									"url": sap.ui.require.toUrl("sap/btp/projectm01")
								}
							}
						}
					}
