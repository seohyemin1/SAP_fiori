		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "first project",
									"targetURL": "#syncprojectb1301-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncprojectb1301-display": {
								"semanticObject": "syncprojectb1301",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.projectb1301",
									"url": sap.ui.require.toUrl("sync/projectb1301")
								}
							}
						}
					}
